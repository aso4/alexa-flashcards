class Alexa < AlexaSkillsRuby::Handler
  ...
  def getWelcomeResponse(callback)
      sessionAttributes = {},
      speechOutput = "I will ask you #{GAME_LENGTH.to_s} questions, try to get as many right as you can. Just say the answer. Let's begin. ",
  ...
  def populateRoundAnswers(gameQuestionIndexes, correctAnswerIndex, correctAnswerTargetLocation)
  ...
  def handleAnswerRequest(intent, session, callback)
      var speechOutput = "";
  ...
  def handleRepeatRequest(intent, session, callback)
  ...
  def handleGetHelpRequest(intent, session, callback)
  ...
  def handleFinishSessionRequest(intent, session, callback) {
  ...
  def buildSpeechletResponseWithoutCard(output, repromptText, shouldEndSession)
      return {
          outputSpeech: {
              type: "PlainText",
              text: output
